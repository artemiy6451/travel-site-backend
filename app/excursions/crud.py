...
# В функции create_excursion_details и update_excursion_details
def create_excursion_details(
    ...
    details_data = details.model_dump()

    db_details = ExcursionDetails(excursion_id=excursion_id, **details_data)
    db.add(db_details)
    db.commit()
...
def get_excursion_full_info(db: Session, excursion_id: int) -> dict:
    ...
    result = {
        ...
        "title": excursion.title,
        "category": excursion.category,
        "description": excursion.description,  # краткое описание
        "date": excursion.date,
        "price": excursion.price,
        "duration": excursion.duration,
        "people_amount": excursion.people_amount,
    ...
    if excursion.details:
        result["details"] = {
            ...
            "excursion_id": excursion.details.excursion_id,  # Добавляем excursion_id
            "description": excursion.details.description,  # полное описание
